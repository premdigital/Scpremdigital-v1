...
# Replace "[1] Ganti Secret Key API Web"
content = content.replace("[1] Ganti Secret Key API Web", "[1] Hubungkan VPS ke Web Auto-Creator")

# Replace case 1) block
old_block = """        1)
            clear
...
# Fix jq missing in apt install
content = content.replace("curl wget wget2 nano python3", "curl wget wget2 nano jq python3")
